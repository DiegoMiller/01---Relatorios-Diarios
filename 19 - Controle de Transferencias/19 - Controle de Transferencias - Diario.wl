...
$dtOntem=DateString[DatePlus[-1],{"Day","/","Month","/","Year"}];
$dtOntemExcel=DateString[DatePlus[-1],{"Day","-","Month","-","Year"}];
...
gridTRANSF[data_Symbol]:=Module[{grid,title,r,color2,stl},
	...
	title=Style[Row@{"Transfer\[EHat]ncias efetivadas em ", $dtOntem},maTitleFormatOptions];
...
$fileNameTRANSF="Relacao de produtos transferidos em "<>$dtOntemExcel<>".xlsx";
Export["Relacao de produtos transferidos em "<>$dtOntemExcel<>".xlsx",r[99]["DataAll"]];


marcheMail[
  		"[GE] Transfer\[EHat]ncias efetivadas em " <>$dtOntem
  		,"Transfer\[EHat]ncias efetivadas em " <>$dtOntem
  		,$mailsGerencia
