...
createReport[s];
rep=marcheTemplate[grid=Row@{"Pend\[EHat]ncias de emiss\[ATilde]o de NF da 7-Hortus para 26-Alimentum Restaurante"},createReport[s],1200, $logo];
...
$fileName1="Pend\[EHat]ncias de emiss\[ATilde]o de NF da 7-Hortus para 26-Alimentum Restaurante.png";
Export["Pend\[EHat]ncias de emiss\[ATilde]o de NF da 7-Hortus para 26-Alimentum Restaurante.png",rep];


$fileName="EXCLUSIVO ESM - VENDA HORTUS PARA ALIMENTUM.xlsx";
Export["EXCLUSIVO ESM - VENDA HORTUS PARA ALIMENTUM.xlsx",r["DataAll"]];		


$fileName2="Emissao de nota com quantidade maior que a transferencia.xlsx";
Export["Emissao de nota com quantidade maior que a transferencia.xlsx",r3["DataAll"]];		
